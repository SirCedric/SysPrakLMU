        ...
        <div id="page-container">
            <div class="page-content" id="content-wrap">
                <div class="mdl-grid">
                    ...
                    $sql = "SELECT Headline, Content FROM Ausrüstung WHERE id=3";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<div class='mdl-card news_Card_location mdl-shadow--4dp mdl-cell mdl-cell--6-col mdl-cell--12-col-phone mdl-cell--6-col-tablet'>";
