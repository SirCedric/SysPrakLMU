              ...
              <div class="mdl-grid">
                ...
                <div class="center_text mdl-cell mdl-cell--10-col mdl-cell--10-col-tablet mdl-cell--12-col-phone">
                        ...
                        <ul class="demo-list-two mdl-list">
                          ...
                          <li class="mdl-list__item mdl-list__item--two-line">
                            <span class="mdl-list__item-primary-content">
                              <a class="center_text mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="stufenContent.php?article=1">
                                  Die Wölflinge
                              </a>
                          ...
                          <li class="mdl-list__item mdl-list__item--two-line">
                            <span class="mdl-list__item-primary-content">
                              <a class="center_text mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="stufenContent.php?article=2">
                                  Die Jungpfadfinder
                              </a>
                          ...
                          <li class="mdl-list__item mdl-list__item--two-line">
                            <span class="mdl-list__item-primary-content">
                              <a class="center_text mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="stufenContent.php?article=3">
                                  Die Pfadfinder
                              </a>
                          ...
                          <li class="mdl-list__item mdl-list__item--two-line">
                            <span class="mdl-list__item-primary-content">
                              <a class="center_text mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="stufenContent.php?article=4">
                                  Die Rover
                              </a>
                          ...
                          <li class="mdl-list__item mdl-list__item--two-line">
                            <span class="mdl-list__item-primary-content">
                              <a class="center_text mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="stufenContent.php?article=5">
                                  Die Leiterrunde
                              </a>
                  ...
                  <div class="mdl-card__actions mdl-card--border">
                      <a class="center_text mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="stammesInfo.php" >Zurück zur Übersicht</a>
                  </div>
                </div>
